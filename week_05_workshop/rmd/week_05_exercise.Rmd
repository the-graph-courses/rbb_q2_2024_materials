...
Your data should have 7 variables now: - `sex`: male or female - `status`: adult (Adulte) or child (Enfant) - `bmi`: body mass index - `sedentary_ap_s_day`: sedentary behaviour (seconds/week) - `light_ap_s_day`: light physical activity (seconds/week) - `mvpa_s_day`: moderate to vigorous physical activity (seconds/week) - `oms_recommendation`: whether or not WHO recommendations for physical activity are being met (OMS stands for Organisation Mondiale de la Santé, which is the French name for WHO)
...
The due date for the assignment is **Friday, May 10th** at 23:59 PM GMT.
